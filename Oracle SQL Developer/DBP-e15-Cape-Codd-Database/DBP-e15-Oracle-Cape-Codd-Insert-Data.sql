...
INSERT INTO RETAIL_ORDER VALUES (
	1000, 10, '98110', 'December', 2017, 445);
INSERT INTO RETAIL_ORDER VALUES (
	2000, 20, '02335', 'December', 2017, 310);
INSERT INTO RETAIL_ORDER VALUES (
	3000, 10, '98110', 'January', 2018, 480);
...
/*  SQL code to insert the data into CATALOG_SKU_2016:   */

INSERT INTO CATALOG_SKU_2016 VALUES (
	 seqCSKU16.NextVal, 100100, 'Std. Scuba Tank, Yellow', 'Water Sports', 23,
   TO_DATE('01/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES ( 
	seqCSKU16.NextVal, 100500, 'Std. Scuba Tank, Light Green', 'Water Sports', NULL,
  TO_DATE('07/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES ( 
	 seqCSKU16.NextVal, 100600, 'Std. Scuba Tank, Dark Green', 'Water Sports', NULL,
   TO_DATE('07/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES (    
	 seqCSKU16.NextVal, 101100, 'Dive Mask, Small Clear', 'Water Sports', 24,
   TO_DATE('01/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES ( 
	 seqCSKU16.NextVal, 101200, 'Dive Mask, Med Clear', 'Water Sports', 24,
   TO_DATE('01/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES (    
   seqCSKU16.NextVal, 201000, 'Half-dome Tent', 'Camping', 45,
   TO_DATE('01/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES (
   seqCSKU16.NextVal, 202000, 'Half-dome Tent Vestibule', 'Camping', 47,
   TO_DATE('01/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES (    
	 seqCSKU16.NextVal, 301000, 'Light Fly Climbing Harness', 'Climbing', 76,
   TO_DATE('01/01/16', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2016 VALUES (    
	 seqCSKU16.NextVal, 302000, 'Locking Carabiner, Oval', 'Climbing', 78,
   TO_DATE('01/01/16', 'MM/DD/YY'));
  
/*  SQL code to insert the data into CATALOG_SKU_2017:   */
  
INSERT INTO CATALOG_SKU_2017 VALUES (
	seqCSKU17.NextVal, 100100, 'Std. Scuba Tank, Yellow', 'Water Sports', 23,
  TO_DATE('01/01/17', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2017 VALUES (
  seqCSKU17.NextVal, 100300, 'Std. Scuba Tank, Light Blue', 'Water Sports', 23,
  TO_DATE('01/01/17', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 100400, 'Std. Scuba Tank, Dark Blue', 'Water Sports', NULL,
  TO_DATE('08/01/17', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 101100, 'Dive Mask, Small Clear', 'Water Sports', 26,
  TO_DATE('01/01/17', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 101200, 'Dive Mask, Med Clear', 'Water Sports', 26,
  TO_DATE('01/01/17', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 201000, 'Half-dome Tent', 'Camping', 46,
  TO_DATE('01/01/17', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 202000, 'Half-dome Tent Vestibule', 'Camping', 46,
  TO_DATE('01/01/17', 'MM/DD/YY'));
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 301000, 'Light Fly Climbing Harness', 'Climbing', 77,
  TO_DATE('01/01/17', 'MM/DD/YY'));		
INSERT INTO CATALOG_SKU_2017 VALUES	(
  seqCSKU17.NextVal, 302000, 'Locking Carabiner, Oval', 'Climbing', 79,
  TO_DATE('01/01/17', 'MM/DD/YY'));	 
  
/*  SQL code to insert the data into CATALOG_SKU_2018:   */
  
INSERT INTO CATALOG_SKU_2018 VALUES (
	 seqCSKU18.NextVal,100100, 'Std. Scuba Tank, Yellow', 'Water Sports', 23,
   TO_DATE('01/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,100200, 'Std. Scuba Tank, Magenta', 'Water Sports', 23,
  TO_DATE('01/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,101100, 'Dive Mask, Small Clear', 'Water Sports', 27,
  TO_DATE('08/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,101200, 'Dive Mask, Med Clear', 'Water Sports', 27,
  TO_DATE('01/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,201000, 'Half-dome Tent', 'Camping', 45,
  TO_DATE('01/01/18', 'MM/DD/YY'));		
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,202000, 'Half-dome Tent Vestibule', 'Camping', 45,
  TO_DATE('01/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,203000, 'Half-dome Tent Vestibule - Wide', 'Camping', NULL,
  TO_DATE('04/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,301000, 'Light Fly Climbing Harness', 'Climbing', 76,
  TO_DATE('01/01/18', 'MM/DD/YY'));	
INSERT INTO CATALOG_SKU_2018 VALUES	(
  seqCSKU18.NextVal,302000, 'Locking Carabiner, Oval', 'Climbing', 78,
  TO_DATE('01/01/18', 'MM/DD/YY'));	
